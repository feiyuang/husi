...
class ProxyGroupSettingsActivity :
    ProfileSettingsActivity<GroupBean>(R.layout.layout_chain_settings) {

    override fun createEntity() = GroupBean().applyDefaultValues()

    val proxyList = mutableListOf<ProxyEntity>()

    override fun GroupBean.init() {
    ...
    override fun GroupBean.serialize() {
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        addPreferencesFromResource(R.xml.proxy_group_preferences)
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { (resultCode, data) ->
            if (resultCode == RESULT_OK) runOnDefaultDispatcher {
                ...
                if (!testProfileAllowed(profile)) {
                    onMainDispatcher {
                        MaterialAlertDialogBuilder(this@ProxyGroupSettingsActivity)
        ...
        fun bind() {
            binding.root.setOnClickListener {
                ...
                selectProfileForAdd.launch(
                    Intent(
                        this@ProxyGroupSettingsActivity, ProfileSelectActivity::class.java
                    )
                )
            }
        }
